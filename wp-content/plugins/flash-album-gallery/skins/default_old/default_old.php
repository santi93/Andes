<?php
/*
Skin Name: Midnight International
Skin URI: 
Description: Default international skin included in GRAND Flash Album Gallery plugin. <br />You can use any language you want for album name, alt/title and description in FlAGallery  ;)<br /><br />Details: system font for image description, bottom thumbnails, fullscreen button (FS), slideshhow button (SL), backlink to PhotoGalleryCreator.com (PGC), image description button (i)
Author: PGC
