...
<div id="slide-wrapper">
		...
		$args = array( 'meta_key' => 'front_sl_slider', 'meta_value'=> '1', 'post_type' => array('post', 'project'), 'suppress_filters' => 0, 'numberposts' => $front_sl_slide_max, 'orderby' => $front_sl_slide_order, 'order' => $front_sl_slide_sort, 'category' => $front_sl_slide_categories);
		
                if($front_slide_categories != 0) {
                        
                        $args = array('post_type' => array('post', 'project'), 'suppress_filters' => 0, 'numberposts' => $front_sl_slide_max, 'orderby' => $front_sl_slide_sort, 'order' => $front_sl_slide_order, 'category' => $front_sl_slide_categories);
			...
			$thumb = front_sl_get_thumb("front_size");
                ...
                ?>
                        ...
                        <li>
                                ...
                                <a href="<?php the_permalink();?>"><img src="<?php echo $thumb_small;?>" alt=""> </a>		
                        </li> 	                    	 
