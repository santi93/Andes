	...
	<div id="content-slideshow">
		...
		<div class="content_slideshow">
			...
			$querystr = "
				...
				AND (wposts.post_type = 'post' OR wposts.post_type = 'page' OR wposts.post_type = 'projects')";
    	...
    	<div class="slideme"><a href="http://www.aesthetic-klinik-hannover.de/schoenheitsoperation/fettabsaugung-hannover/" title="Fettabsaugen Hannover" target="_blank">Aesthetic</a></div>
